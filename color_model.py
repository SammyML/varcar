...
def main():
    ...
    while True:
        ...
        if closest_color is not None:
            print("\nColor Information:")
            print(f"Color Name: {closest_color['color_name']}")
            print(f"Color ID: {closest_color['color_id']}")
            print(f"Color Code: {closest_color['color_code']}")
            print(f"Color Type: {closest_color['color_type']}")
        else:
            print("Color information not found for the detected color.")
